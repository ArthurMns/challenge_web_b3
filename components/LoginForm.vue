    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm bg-white p-6 rounded-lg shadow-lg">
      <form class="space-y-6" action="#" method="POST">
        <div>
          ...
          <div class="mt-2">
            <input id="email" name="email" type="email" autocomplete="email" required class="bg-white block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <nuxt-link to="/forgot-password" class="font-semibold text-orange-600 hover:text-orange-500">Mot de passe oublié ?</nuxt-link>
            </div>
          </div>
          <div class="mt-2">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Pas encore membre?
        {{ ' ' }}
        <nuxt-link to="/signup" class="font-semibold leading-6 text-orange-600 hover:text-orange-500">Inscription</nuxt-link>
      </p>
    </div>
  </div>
</template>
